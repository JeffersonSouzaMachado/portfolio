...
abstract interface class HomeRepository {
  Future<List<MetricResumeEntity>> getMetrics(String language);
}
...
class HomeRepositoryImpl implements HomeRepository {
  ...
  @override
  Future<List<MetricResumeEntity>> getMetrics(String language) async {
    return _remoteDataSource.getMetrics(language);
  }
}
